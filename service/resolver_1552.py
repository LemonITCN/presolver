...
# 五宫不规则数独 五宫锯齿数独
class Resolver1552(ResolverBase):
    ANSWER_RANGE = ['1', '2', '3', '4', '5']

    def get_answer_range(self) -> []:
        return Resolver1552.ANSWER_RANGE

    def calculate_rules(self):
        super().calculate_rules()
        self.question_data.rules_list = [
            RuleItemMutex(self.question_data, '0,0;0,1;0,2;0,3;0,4'),
            RuleItemMutex(self.question_data, '1,0;1,1;1,2;1,3;1,4'),
            RuleItemMutex(self.question_data, '2,0;2,1;2,2;2,3;2,4'),
            RuleItemMutex(self.question_data, '3,0;3,1;3,2;3,3;3,4'),
            RuleItemMutex(self.question_data, '4,0;4,1;4,2;4,3;4,4'),

            RuleItemMutex(self.question_data, '0,0;1,0;2,0;3,0;4,0'),
            RuleItemMutex(self.question_data, '0,1;1,1;2,1;3,1;4,1'),
            RuleItemMutex(self.question_data, '0,2;1,2;2,2;3,2;4,2'),
            RuleItemMutex(self.question_data, '0,3;1,3;2,3;3,3;4,3'),
            RuleItemMutex(self.question_data, '0,4;1,4;2,4;3,4;4,4'),
        ]
                        ...
                        for location_tag in location_group.split(':'):
                            if location_tag != '':
                                ...
                                self.question_data.rules_list.append(
                                    RuleItemMutex(self.question_data, ';'.join(cells_list)))
